object FrmFaseProducaoDefeitoEstornar: TFrmFaseProducaoDefeitoEstornar
  Left = 0
  Top = 0
  ...
  inline FrmFrameBarra1: TFrmFrameBarra
    ...
    inherited W7Panel1: TPanel
      ...
      inherited LblBarraTitulo: TLabel
        Width = 285
        Caption = 'Estornar Defeito | Andamento de fase'
        ExplicitWidth = 285
      end
    end
  end
  ...
  object db_Defeito: TFDQuery
    ...
    AfterOpen = db_DefeitoAfterOpen
    BeforePost = db_DefeitoBeforePost
    AfterScroll = db_DefeitoAfterScroll
