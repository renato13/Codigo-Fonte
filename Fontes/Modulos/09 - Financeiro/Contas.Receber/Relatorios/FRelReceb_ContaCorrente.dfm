object FrmRelReceb_ContaCorrente: TFrmRelReceb_ContaCorrente
  ...
  object TblFornecedor: TTable
    AutoRefresh = True
    DatabaseName = 'ATENDIMENTO'
    IndexName = 'CODIGO'
    MasterFields = 'FORNEC'
    MasterSource = DSCtaPagar
    TableName = 'Arq_Fornecedor'
    Left = 80
    Top = 16
  end
  ...
  object TblFPagto: TTable
    AutoRefresh = True
    DatabaseName = 'ATENDIMENTO'
    IndexFieldNames = 'CODIGO'
    MasterFields = 'FPAGTO'
    MasterSource = DSCtaPagar
    TableName = 'Arq_FormaPagto.db'
    Left = 48
    Top = 16
  end
  object Qry_CtaPagar: TQuery
    AfterOpen = Qry_CtaPagarAfterOpen
    AfterClose = Qry_CtaPagarAfterClose
    AutoRefresh = True
    DatabaseName = 'ATENDIMENTO'
    SQL.Strings = (
      
        'SELECT A.DOCUMENTO, A.FORNEC, A.DATA, A.VENC, A.VLRDOC, A.FPAGTO' +
        ', A.ESPECIE, A.HISTORICO, A.QUITADO,'
      '    A.BANCO, A.AGENCIA, A.CONTA_C,'
      
        '    B.DOCUMENTO, B.FORNEC, B.DATA, B.PARCELA, B.VENC, B.VALOR, B' +
        '.ESPECIE, B.QUITADO'
      'FROM CtaPagar A, ParcPagar B'
      'WHERE '
