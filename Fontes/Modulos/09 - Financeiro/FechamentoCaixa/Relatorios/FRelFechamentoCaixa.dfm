object FrmRelFechamentoCaixa: TFrmRelFechamentoCaixa
  ...
  object Panel1: TPanel
    ...
    object GrpPlanoContas: TGroupBox
      Left = 1
      Top = 153
      Width = 462
      Height = 99
    ...
    object RadioMovimentacao: TRadioGroup
      Left = 1
      Top = 252
      Width = 462
      Height = 55
    ...
    object RadioStatus: TRadioGroup
      ...
      Height = 76
      Align = alTop
      Caption = 'Quais Contas Deseja Processar:'
      Columns = 3
      ItemIndex = 0
      Items.Strings = (
        'Todas'
    ...
    object GroupBox1: TGroupBox
      ...
      object EditDepartamento: TIDBEditDialog
        Left = 10
        Top = 60
        Width = 95
        Height = 21
        ...
        ButtonKeyClickBtn = 119
        SQLdbFazBusca = True
        SQLdbFocusControl = EditDepartamentoNome
        ...
        SearchQuery.Strings = (
          ...
          '%WHERE%')
        CountQuery.Strings = (
          'SELECT COUNT(CODIGO) FROM DEPARTAMENTOS'
          'WHERE'
          '%WHERE%')
        SearchDialogFieldList = <
          item
      ...
      object EditDepartamentoNome: TEdit
        Left = 111
        Top = 60
        Width = 338
        Height = 21
