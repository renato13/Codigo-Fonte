object FrmUsuarioLog: TFrmUsuarioLog
  ...
  object db_UsuarioLog: TFDQuery
    ...
    object db_UsuarioLogCODIGO: TIntegerField
      FieldName = 'CODIGO'
    end
    object db_UsuarioLogUSERNAME: TStringField
      FieldName = 'USERNAME'
      Size = 30
    end
    object db_UsuarioLogDATA: TSQLTimeStampField
      FieldName = 'DATA'
    end
    object db_UsuarioLogHORAS: TTimeField
      FieldName = 'HORAS'
    end
    object db_UsuarioLogMODULO: TStringField
      FieldName = 'MODULO'
      Size = 5000
    end
    object db_UsuarioLogACAO: TStringField
      FieldName = 'ACAO'
      Size = 5000
    end
  end
