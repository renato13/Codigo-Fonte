object FrmRelVeiculos: TFrmRelVeiculos
  Left = 385
  Top = 162
  BorderStyle = bsDialog
  Caption = 'Relat'#243'rio de Veiculos'
  ClientHeight = 339
  ClientWidth = 494
  Color = clBtnFace
  ...
  object GroupBox1: TGroupBox
    ...
    Caption = 'Ve'#237'culo'
    TabOrder = 3
    object ChkVeiculo: TCheckBox
      Left = 8
      Top = 25
      Width = 153
      Height = 17
      Cursor = crHandPoint
      Caption = 'Todos os Ve'#237'culos'
      Checked = True
      State = cbChecked
      TabOrder = 0
      OnClick = ChkVeiculoClick
    end
    object EditVeiculo: TIDBEditDialog
      Left = 10
      Top = 63
      Width = 52
      Height = 21
      ...
      SearchQuery.Strings = (
        ...
        '%WHERE%')
      CountQuery.Strings = (
        'SELECT COUNT(*) FROM VIEW_VEICULO '
        'WHERE'
        '%WHERE%')
      SearchDialogFieldList = <
        item
