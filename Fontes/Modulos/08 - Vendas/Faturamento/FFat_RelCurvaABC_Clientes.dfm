object FrmFat_RelCurvaABC_Clientes: TFrmFat_RelCurvaABC_Clientes
  Left = 199
  Top = 113
  Caption = 'Curva ABC de Faturamento por Cliente'
  ClientHeight = 410
  ClientWidth = 834
  Color = clBtnFace
  ...
  object QuickRep: TQuickRep
    ...
    PrintIfEmpty = True
    ReportTitle = 'CURVA ABC DE CLIENTES'
    SnapToGrid = True
    Units = MM
    Zoom = 100
  ...
  object DB_Vendas: TFDQuery
    ...
    SQL.Strings = (
      ...
      'B.CODIGO=A.CLIENTE'
      'AND'
      'B.TIPO='#39'CLIENTE'#39
      ''
      'Group by A.CLIENTE, B.NOME'
