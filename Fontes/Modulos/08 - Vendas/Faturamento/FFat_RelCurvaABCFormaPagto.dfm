object FrmFat_RelCurvaABCFormaPagto: TFrmFat_RelCurvaABCFormaPagto
  Left = 200
  Top = 108
  Caption = 'Curva ABC de Faturamento por Forma de Pagamento'
  ClientHeight = 429
  ClientWidth = 847
  Color = clBtnFace
  ...
  object QuickRep: TQuickRep
    ...
    PrintIfEmpty = True
    ReportTitle = 'Curva ABC de Faturamento por Forma de Pagamento'
    SnapToGrid = True
    Units = MM
    Zoom = 100
    ...
    object Band_Cabecalho: TQRBand
      ...
      object LblTitulo: TQRLabel
        ...
        AlignToBand = False
        AutoSize = False
        Caption = 'RANKING DE FORMAS DE PAGAMENTOS'
        Color = clSilver
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Height = -12
  ...
  object DB_VENDAS: TFDQuery
    ...
    SQL.Strings = (
      'select'
      'B.NOME as Nomepagto,'
      'B.TIPO_PAGAMENTO as TIPO,'
      ''
      'Sum(A.total_nf)  as Faturamento'
      ' from VENDAS A, CAD_FORMAPAGTO B '
      'WHERE'
      'B.CODIGO=A.FORMAPAGTO'
      'group by A.FORMAPAGTO, '
      'B.TIPO_PAGAMENTO,'
      'B.NOME'
