...
begin
  ...
  Begin
    Showmessage('Programador(a), não foi definido um DataSource para o componente '+Self.Name);
    Exit;
  End;
  ...
  begin
     ...
     begin
       ...
       // se não foi informado um "CAMPO" então salvar na propriedade "TEXT" do
       // componente
       ...
       begin
          // se foi informado um "CAMPO" então salvar diretamente no banco de dados
...
begin
  ...
  Begin
     ...
     Begin
        ...
        'não foi definido uma conexão válida na propriedade "ConnectionDialog" para o componente '+Self.Name);
        Exit;
     End;
  End;
  }
